        ...
        <FormItem>
          ...
          <FormControl>
            <Input
              ...
              {...field}
              type={type}
              className="dark:bg-gray-600 border-neutral-200 dark:border-gray-500 dark:placeholder-gray-100 dark:text-white dark:focus:ring-blue-300 dark:focus:border-blue-300"
            />
          </FormControl>
